...
Навыки с `bow` требуют стрелы. Навыки с `crossbow` требуют болты. Если навык имеет несколько видов оружия, боеприпас проверяется только для текущего экипированного оружия.
