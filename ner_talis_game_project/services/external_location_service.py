...
Вы поднялись на старое плато на полуострове, с трёх сторон окружённое океаном. Перед вами раскинулись древние руины, занимающие почти всё плато. Кажется, здесь уже давно всё осмотрели, и ничего ценного не осталось.

Среди сотен разрушенных зданий, ближе к южному краю, виднеется площадь с очень древней повреждённой аркой."""
...
Перед вами раскинулись Холмистые луга. Невысокие зелёные холмы тянутся к горизонту, трава колышется под ветром, а между склонами то и дело мелькают следы жизни."""
...
Крепость стоит на дороге между полуостровом Селдара и внутренними землями материка. Со стороны материка стены укреплены особенно серьёзно: тяжёлые ворота, сторожевые площадки, следы старых осад и глубокие отметины от когтей монстров напоминают, что это место не раз принимало удар на себя."""
FORTRESS_TOWN_HALL_TEXT = """🏛 Крепостная ратуша

В каменном зале крепости царит строгий порядок. Здесь ведут записи взысканий, принимают важные распоряжения и решают дела, связанные с долгами, наградами и защитой крепости."""

FORTRESS_ALLEYS_TEXT = """🌘 Переулки крепости

Между складами, задними воротами и лавками ходят люди, которые не любят громких вывесок."""

FORTRESS_SEEKER_OUTPOST_TEXT = """🛡 Застава Искателей
Это укреплённое место в крепости, где собираются те, кто готов работать за стенами. Здесь можно нанять команду или рабочих, разместить заказ на Доске объявлений, посмотреть чужие поручения и обратиться к Агенту Гильдии для участия в рейдах, подземельях и дальних походах."""
