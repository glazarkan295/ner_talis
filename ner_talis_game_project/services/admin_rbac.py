...
# Конструктор боевых настроек (таймер/порядок ходов, ТЗ 20).
PERM_COMBAT_VIEW = "combat.view"
PERM_COMBAT_CREATE = "combat.create"
PERM_COMBAT_EDIT = "combat.edit"
PERM_COMBAT_VALIDATE = "combat.validate"
PERM_COMBAT_PUBLISH = "combat.publish"
PERM_COMBAT_DISABLE = "combat.disable"
PERM_COMBAT_ARCHIVE = "combat.archive"
PERM_COMBAT_DELETE = "combat.delete"
# Конструктор NPC-союзников (ТЗ 21 §2).
PERM_NPC_ALLY_VIEW = "npc_ally.view"
PERM_NPC_ALLY_CREATE = "npc_ally.create"
PERM_NPC_ALLY_EDIT = "npc_ally.edit"
PERM_NPC_ALLY_VALIDATE = "npc_ally.validate"
PERM_NPC_ALLY_PUBLISH = "npc_ally.publish"
PERM_NPC_ALLY_DISABLE = "npc_ally.disable"
PERM_NPC_ALLY_ARCHIVE = "npc_ally.archive"
PERM_NPC_ALLY_DELETE = "npc_ally.delete"
# Конструктор «Информатор Крот» (ТЗ 21 §3).
PERM_MOLE_VIEW = "mole.view"
PERM_MOLE_CREATE = "mole.create"
PERM_MOLE_EDIT = "mole.edit"
PERM_MOLE_VALIDATE = "mole.validate"
PERM_MOLE_PUBLISH = "mole.publish"
PERM_MOLE_DISABLE = "mole.disable"
PERM_MOLE_ARCHIVE = "mole.archive"
PERM_MOLE_DELETE = "mole.delete"
# Конструктор «Подпольное казино» (ТЗ 21 §4).
PERM_CASINO_VIEW = "casino.view"
PERM_CASINO_CREATE = "casino.create"
PERM_CASINO_EDIT = "casino.edit"
PERM_CASINO_VALIDATE = "casino.validate"
PERM_CASINO_PUBLISH = "casino.publish"
PERM_CASINO_DISABLE = "casino.disable"
PERM_CASINO_ARCHIVE = "casino.archive"
PERM_CASINO_DELETE = "casino.delete"
# Конструктор правил очереди сообщений (ТЗ 2.0, файл 18).
PERM_MESSAGE_RULE_VIEW = "message_rule.view"
PERM_MESSAGE_RULE_CREATE = "message_rule.create"
PERM_MESSAGE_RULE_EDIT = "message_rule.edit"
PERM_MESSAGE_RULE_VALIDATE = "message_rule.validate"
PERM_MESSAGE_RULE_PUBLISH = "message_rule.publish"
PERM_MESSAGE_RULE_DISABLE = "message_rule.disable"
PERM_MESSAGE_RULE_ARCHIVE = "message_rule.archive"
PERM_MESSAGE_RULE_DELETE = "message_rule.delete"
# Конструктор квестов и заданий (ТЗ 2.0, файл 10).
PERM_QUEST_VIEW = "quest.view"
PERM_QUEST_CREATE = "quest.create"
PERM_QUEST_EDIT = "quest.edit"
PERM_QUEST_VALIDATE = "quest.validate"
PERM_QUEST_PUBLISH = "quest.publish"
...
PERM_HOUSING_EDIT = "housing.edit"
PERM_HOUSING_VALIDATE = "housing.validate"
PERM_HOUSING_PUBLISH = "housing.publish"
PERM_HOUSING_DISABLE = "housing.disable"
PERM_HOUSING_ARCHIVE = "housing.archive"
PERM_HOUSING_DELETE = "housing.delete"
...
ALL_PERMISSIONS = (
    ...
    PERM_COMBAT_VIEW, PERM_COMBAT_CREATE, PERM_COMBAT_EDIT, PERM_COMBAT_VALIDATE,
    PERM_COMBAT_PUBLISH, PERM_COMBAT_DISABLE, PERM_COMBAT_ARCHIVE, PERM_COMBAT_DELETE,
    PERM_NPC_ALLY_VIEW, PERM_NPC_ALLY_CREATE, PERM_NPC_ALLY_EDIT, PERM_NPC_ALLY_VALIDATE,
    PERM_NPC_ALLY_PUBLISH, PERM_NPC_ALLY_DISABLE, PERM_NPC_ALLY_ARCHIVE, PERM_NPC_ALLY_DELETE,
    PERM_MOLE_VIEW, PERM_MOLE_CREATE, PERM_MOLE_EDIT, PERM_MOLE_VALIDATE,
    PERM_MOLE_PUBLISH, PERM_MOLE_DISABLE, PERM_MOLE_ARCHIVE, PERM_MOLE_DELETE,
    PERM_CASINO_VIEW, PERM_CASINO_CREATE, PERM_CASINO_EDIT, PERM_CASINO_VALIDATE,
    PERM_CASINO_PUBLISH, PERM_CASINO_DISABLE, PERM_CASINO_ARCHIVE, PERM_CASINO_DELETE,
