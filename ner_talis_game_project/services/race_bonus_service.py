"""Small runtime helpers for race bonuses.

Race descriptions live in ``data/races.json``. These helpers make the first
implemented bonuses available to combat, exploration and progression without
hard-coding the text in every subsystem.
"""
